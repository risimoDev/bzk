 ...
 <!-- Футер -->
  ...
  <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div class="sm:col-span-2">
      <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
        ...
        <span class="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">BZK PRINT</span>
      </a>
    ...
    <div class="space-y-2 text-sm">
      ...
      <div class="flex">
        <p class="mr-1 text-gray-800">Телефоно:</p>
  ...
  <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
    <p class="text-sm text-gray-600">
      © Copyright 2025 bzkprint.ru. All rights reserved.
    </p>
    <ul class="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
      ...
      <li>
        <a href="/" class="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Политика приватности</a>
      </li>
      <li>
        <a href="/" class="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Правила &amp; Использования</a>
      </li>
    </ul>
  </div>
</div>
