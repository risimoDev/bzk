...
<main class="bg-pattern min-h-screen bg-gradient-to-br from-[#DEE5E5] to-[#9DC5BB] py-8">
 ...
 <div class="container mx-auto px-4 py-4 flex justify-between items-center">
    ...
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-gray-700 max-w-3xl mx-auto">Для обеспечения высокого качества печати и безупречного результата, пожалуйста, внимательно ознакомьтесь с нашими требованиями к макетам.</p>
      ...
      <div class="flex items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-lg leading-relaxed">
            Соблюдение этих требований поможет избежать ошибок, ускорит процесс подготовки вашего заказа и обеспечит идеальное качество печати. 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
      <div class="bg-white rounded-2xl shadow-lg p-8 text-center transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group">
        <div class="w-20 h-20 bg-[#118568] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#17B890] transition-colors duration-300">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-8 text-center transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group">
        <div class="w-20 h-20 bg-[#17B890] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#118568] transition-colors duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-8 text-center transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group">
        <div class="w-20 h-20 bg-[#5E807F] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#118568] transition-colors duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
      ...
      <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
        <a href="/contacts" class="bg-[#118568] text-white px-8 py-3 rounded-lg hover:bg-[#0f755a] transition-all duration-300 transform hover:scale-105 font-medium flex items-center">
