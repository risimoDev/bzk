    ...
    <div class="mb-8 border-b border-[#DEE5E5]">
      <nav class="flex flex-wrap gap-2 overflow-x-auto pb-2 -mx-2 px-2">
        <button onclick="showTab('profile')" id="profile-tab"
          ...
          <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2 <?php echo $active_tab === 'profile' ? 'text-white' : 'text-[#118568]'; ?>"
        ...
        <button onclick="showTab('security')" id="security-tab"
          ...
          <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2 <?php echo $active_tab === 'security' ? 'text-white' : 'text-[#118568]'; ?>"
              fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <?php if ($notifications_enabled): ?>
          <button onclick="showTab('notifications')" id="notifications-tab"
            ...
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mr-2 <?php echo $active_tab === 'notifications' ? 'text-white' : 'text-[#118568]'; ?>"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <button onclick="showTab('corporate')" id="corporate-tab"
          ...
          <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2 <?php echo $active_tab === 'corporate' ? 'text-white' : 'text-[#118568]'; ?>"
              fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <button onclick="showTab('telegram')" id="telegram-tab"
          ...
          <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2 <?php echo $active_tab === 'telegram' ? 'text-white' : 'text-[#118568]'; ?>"
              fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div id="profile-tab-content" class="tab-content bg-white rounded-3xl shadow-2xl overflow-hidden">
      <div class="p-6 border-b border-gray-200">
        <h2 class="text-2xl font-bold text-gray-800 flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 text-[#118568]" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
          </svg>
            ...
            <div class="relative">
              ...
              <div class="absolute left-4 top-3.5 text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M9 12l2 2 4-4m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
              </div>
            </div>
          </div>
        ...
        <form action="" method="POST" class="p-6">
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-center justify-between p-4 bg-white rounded-lg shadow border border-gray-200">
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" name="telegram_notifications" class="sr-only peer" id="telegram-notifications"
                  <?php echo isset($user['telegram_notifications']) && $user['telegram_notifications'] ? 'checked' : ''; ?>   <?php echo !$user['telegram_chat_id'] ? 'disabled' : ''; ?>>
                <div
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700">
                  <p>Ваш запрос на корпоративный аккаунт находится на рассмотрении. После обработки запроса вы сможете
                    подать новый запрос.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <form action="" method="POST" class="p-6">
          ...
          <div class="space-y-6">
            <div>
              ...
              <input type="text" name="company_name" placeholder="Введите полное название вашей компании"
                class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"
                required>
            </div>
            ...
            <div>
              ...
              <input type="text" name="inn" placeholder="Введите ИНН компании"
                class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"
                required>
            </div>
            ...
            <div>
              ...
              <input type="text" name="kpp" placeholder="Введите КПП компании"
                class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300">
            </div>

            <div>
              <label class="block text-gray-700 font-medium mb-2">Юридический адрес</label>
              <textarea name="legal_address" placeholder="Введите юридический адрес компании"
                class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300 resize-none"
            ...
            <div class="flex items-center p-4 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <div>
                ...
                <ol class="text-sm text-gray-600 list-decimal list-inside mt-1">
                  <li>Найдите нашего бота в Telegram: <a href="https://t.me/<?php echo TELEGRAM_BOT_USERNAME; ?>"
                      target="_blank" class="text-[#118568] font-medium">@<?php echo TELEGRAM_BOT_USERNAME; ?></a></li>
                  <li>Нажмите "Start" или отправьте команду /start</li>
                  <li>Отправьте команду <code
                      class="bg-gray-100 px-1 rounded">/connect <?php echo $user['email']; ?></code></li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="space-y-4">
              <div class="flex items-start">
                ...
                <div class="ml-3">
                  ...
                  <a href="https://t.me/<?php echo TELEGRAM_BOT_USERNAME; ?>" target="_blank"
                    class="mt-2 inline-flex items-center px-4 py-2 bg-[#118568] text-white rounded-lg hover:bg-[#0f755a] transition-colors duration-300 font-medium">
              ...
              <div class="flex items-start">
                ...
                <div class="ml-3">
                  ...
                  <div class="mt-2 relative">
                    <code
                      class="block bg-gray-100 px-4 py-3 rounded-lg text-sm font-mono break-all">/connect <?php echo $user['email']; ?></code>
                    <button onclick="copyToClipboard('/connect <?php echo $user['email']; ?>')"
              ...
              <div class="flex items-start">
                ...
                <div class="ml-3">
                  ...
                  <p class="text-sm text-gray-500 mt-1">После успешного подключения вы начнете получать уведомления в
                    Telegram</p>
                </div>
              </div>
            </div>
          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-4">
            <div class="flex">
              ...
              <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700">
                  <p>Ваш запрос на удаление аккаунта находится на рассмотрении. После обработки запроса администратором
                    будет принято решение.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form method="POST">
            ...
            <div id="delete-confirmation-modal"
              ...
              <div class="bg-white rounded-xl max-w-md w-full p-6">
                ...
                <p class="text-gray-600 mb-4">Вы уверены, что хотите удалить свой аккаунт? Это действие нельзя отменить.
                </p>

                <div class="mb-4">
                  <label class="block text-gray-700 font-medium mb-2">Причина удаления (необязательно)</label>
                  <textarea name="deletion_reason" placeholder="Расскажите, почему вы хотите удалить аккаунт"
                ...
                <div class="flex gap-3">
                  <button type="button" id="cancel-delete"
                    class="flex-1 px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors duration-300 font-medium">
                    Отмена
                  </button>
                  <button type="submit"
                    class="flex-1 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors duration-300 font-medium">
                    Удалить
                  </button>
                </div>
              </div>
