        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div class="p-6 border-b border-gray-200">
            <h2 class="text-2xl font-bold text-gray-800 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 text-[#118568]" fill="none"
          ...
          <form action="" method="POST" class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label class="block text-gray-700 font-medium mb-2">Telegram ID</label>
                <input type="text"
                  value="<?php echo $user['telegram_chat_id'] ? htmlspecialchars($user['telegram_chat_id']) : 'Не подключен'; ?>"
                  disabled class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                <p class="text-sm text-gray-500 mt-1">
                  <?php if (!$user['telegram_chat_id']): ?>
                    Для подключения напишите боту: /connect <?php echo htmlspecialchars($user['email']); ?>
                  <?php else: ?>
            ...
            <div class="mt-6">
              ...
              <textarea name="shipping_address" placeholder="Введите полный адрес доставки"
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-6 sticky top-8">
          ...
          <div class="space-y-4">
            <a href="/client/orders"
              ...
              <div
                class="w-12 h-12 bg-[#118568] rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <a href="/client/settings"
              ...
              <div
                class="w-12 h-12 bg-[#17B890] rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="/logout"
              ...
              <div
                class="w-12 h-12 bg-red-500 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
