  ...
  if (!empty($validation_errors)) {
    ...
    if ($stmt->fetch()) {
      ...
      try {
        ...
        // Флаг для показа анимации на дашборде после успешной регистрации
    ...
    <div class="flex flex-col lg:flex-row gap-12 items-center">
      ...
      <div class="w-full lg:w-1/2 text-center lg:text-left">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
          ...
          <a href="/login"
            class="lg:pl-2 inline-block w-full bg-[#DEE5E5] text-[#118568] py-3 rounded-lg hover:bg-[#9DC5BB] transition-all duration-300 font-medium">
            Войти в аккаунт
          </a>
        </div>
      </div>
          ...
          <form action="" method="POST" class="space-y-6">
            ...
            <div class="flex items-start">
              <label class="flex items-start">
                <input type="checkbox" class="rounded border-gray-300 text-[#118568] focus:ring-[#17B890] mt-1"
                  required>
