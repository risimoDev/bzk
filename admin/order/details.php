              ...
              <div class="flex flex-col sm:flex-row gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors duration-300">
                <div class="flex-grow">
                  ...
                  <div class="flex flex-wrap items-center gap-4 text-sm">
                    ...
                    <span class="font-medium">Цена за единицу: <?php echo number_format($item['price'], 0, '', ' '); ?> ₽</span>
                  </div>
                </div>
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-medium"><?php echo number_format($order['total_price'], 0, '', ' '); ?> ₽</span>
            </div>
            ...
            <div class="border-t border-gray-200 pt-4">
              <div class="flex justify-between text-lg font-bold">
                <span>К оплате:</span>
                <span class="text-[#118568]"><?php echo number_format($order['total_price'], 0, '', ' '); ?> ₽</span>
              </div>
            </div>
          </div>
        </div>
