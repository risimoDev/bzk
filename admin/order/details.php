        ...
        <div class="bg-white rounded-3xl shadow-2xl p-6">
          <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-6">
            <div>
              ...
              <div class="flex items-center">
                ...
                <!-- --- Добавлено: Плашка "Срочный заказ" --- -->
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-2">
                ...
                <p class="text-gray-700">
                  ...
                  <?php echo htmlspecialchars($order['phone'] ?? 'Не указано'); ?>
                        ...
                        <!-- --- Добавлено: Отображение комментария --- -->
                <?php if (!empty($contact_info['comment'])): ?>
                <p class="text-gray-700">
                  <span class="font-medium">Комментарий:</span> 
                  <?php echo nl2br(htmlspecialchars($contact_info['comment'])); ?>
                </p>
                <?php endif; ?>
              </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-2xl p-4">
              <h3 class="font-bold text-gray-800 mb-3 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#118568]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0L5 15.243V19a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2h-5z" />
                </svg>
                Доставка
              </h3>
              <div class="space-y-2">
