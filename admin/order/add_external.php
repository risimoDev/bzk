            ...
            <div class="custom-item bg-gray-50 rounded-2xl p-6 mb-4">
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <div>
                  ...
                  <input type="text" name="custom_items[0][name]"
                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg">
                </div>
                <div>
                  <label class="block text-gray-700 font-medium mb-2">Описание</label>
                  <input type="text" name="custom_items[0][description]"
                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg">
                </div>
                <div>
                  <label class="block text-gray-700 font-medium mb-2">Количество</label>
                  <input type="number" name="custom_items[0][quantity]" min="0" value="0"
                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg custom-quantity">
                </div>
                <div>
                  <label class="block text-gray-700 font-medium mb-2">Цена за ед. (₽)</label>
                  <input type="number" step="0.01" name="custom_items[0][unit_price]" min="0" value="0"
                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg custom-price">
                </div>
                <div>
                  <label class="block text-gray-700 font-medium mb-2">Расход за ед. (₽)</label>
                  <input type="number" step="0.01" name="custom_items[0][expense]" min="0" value="0"
                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg custom-expense">
                </div>
              </div>
              <div class="mt-4 flex justify-between items-center">
                ...
                <button type="button"
                  class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 remove-custom-item"
                  style="display: none;">Удалить</button>
              </div>
            </div>
          </div>
          <button type="button" id="add-custom-item"
            class="w-full py-3 bg-[#118568] text-white rounded-xl hover:bg-[#0f755a] transition font-medium">
            + Добавить позицию
          </button>
        </section>
