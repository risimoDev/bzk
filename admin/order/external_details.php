                                                ...
                                                <td class="py-4 px-4">
                                                    <div>
                                                        ...
                                                        <?php if ($item['product_base_price']): ?>
                                                            <p class="text-sm text-gray-600">Базовая цена:
                                                                <?php echo number_format($item['product_base_price'], 0, '', ' '); ?>
                                                                ₽</p>
                                                        <?php endif; ?>
                                                    </div>
                                                </td>
                                                <td class="py-4 px-4 text-center font-medium"><?php echo $item['quantity']; ?>
                                                </td>
                            ...
                            <table class="w-full">
                                ...
                                <tbody>
                                    <?php foreach ($expenses as $expense): ?>
                                        <tr class="border-b border-gray-100">
                                            <td class="py-4 px-4">
                                                <?php echo date('d.m.Y H:i', strtotime($expense['expense_date'])); ?></td>
                                            <td class="py-4 px-4">
                                                <?php echo htmlspecialchars($expense['description'] ?: '-'); ?></td>
                                            <td class="py-4 px-4">
                                                <?php echo htmlspecialchars($expense['category_name'] ?: '-'); ?></td>
                                            <td class="py-4 px-4 text-right font-bold text-red-600">
                                                <?php echo number_format($expense['amount'], 0, '', ' '); ?> ₽</td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
