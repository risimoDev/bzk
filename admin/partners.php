          ...
          <div>
            ...
            <div class="border-2 border-dashed border-[#118568] rounded-2xl p-8 text-center hover:bg-[#f8fafa] transition-colors duration-300">
              ...
              <input type="file" name="logo" accept="image/*" 
                     class="hidden" id="logo-upload" required>
      ...
      <div class="bg-white rounded-3xl shadow-2xl p-6">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
          ...
          <div class="text-gray-600">
            Найдено: <?php echo count($partners); ?> <?php echo count($partners) == 1 ? 'партнер' : (count($partners) < 5 ? 'партнера' : 'партнеров'); ?>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <?php foreach ($partners as $partner): ?>
            <div class="bg-gray-50 rounded-2xl overflow-hidden hover:bg-white hover:shadow-xl transition-all duration-300 group">
              ...
              <div class="p-4">
                <h3 class="text-lg font-bold text-gray-800 text-center group-hover:text-[#118568] transition-colors duration-300">
