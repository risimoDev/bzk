    ...
    <div class="bg-white rounded-3xl shadow-2xl p-6">
      <div class="mb-6 p-4 bg-gray-50 rounded-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
          ...
          <div><span class="font-medium">Предполагаемый расход:</span>
            <?php echo number_format($order['estimated_expense'], 2, '.', ' '); ?> ₽</div>
          <div><span class="font-medium">Фактический расход:</span>
            <?php echo number_format($order['total_expense'], 2, '.', ' '); ?> ₽</div>
          <?php
