...
if (!isset($_SESSION['user_id']) || ($_SESSION['role'] !== 'admin')) { // Предположим, только админ
  ...
  <div class="container mx-auto px-4 max-w-7xl">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
      ...
      <div class="w-full md:w-auto flex flex-wrap gap-2">
        <?php echo backButton(); ?>
        <a href="add_external_order.php" class="px-4 py-2 bg-[#118568] text-white rounded-lg hover:bg-[#0f755a] transition-colors duration-300 text-sm">
          + Внешний заказ
        </a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 mb-8">
        ...
        <form method="GET" class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex items-end">
                <button type="submit" class="px-4 py-2 bg-[#17B890] text-white rounded-md hover:bg-[#14a380] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#17B890]">
                    Применить
                </button>
            </div>
        </form>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div class="bg-white rounded-2xl shadow-xl p-6 text-center hover:shadow-2xl transition-shadow duration-300">
        ...
        <div class="text-2xl font-bold text-[#118568] mb-2"><?php echo number_format($total_income, 2, '.', ' '); ?> ₽</div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 mb-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Расходы по категориям</h2>
        ...
        <table class="w-full">
          <thead class="bg-[#118568] text-white">
            <tr>
              ...
              <th class="py-4 px-6 text-left">Клиент / Описание</th>
          ...
          <tbody class="divide-y divide-[#DEE5E5]">
            ...
            <?php else: ?>
                ...
                <tr class="hover:bg-[#f8fafa] transition-colors duration-300">
                  ...
                  <td class="py-4 px-6">
                    <span class="px-2 py-1 text-xs rounded-full <?php echo $order['source'] === 'site' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'; ?>">
                  ...
                  <td class="py-4 px-6">
                    ...
                    <?php if ($order['description']): ?>
                        <div class="text-xs text-gray-500 mt-1"><?php echo htmlspecialchars($order['description']); ?></div>
                    <?php endif; ?>
                  </td>
                  ...
                  <td class="py-4 px-6">
                    <div class="flex flex-wrap gap-1">
                        ...
                        <!-- Можно добавить просмотр деталей, редактирование и т.д. -->
                    </div>
                  </td>
                </tr>
                <?php endforeach; ?>
