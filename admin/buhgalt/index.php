  ...
  <div class="container mx-auto px-4 max-w-7xl">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
      ...
      <div class="w-full md:w-auto flex flex-wrap gap-2">
        <?php echo backButton(); ?>
        <a href="add_external_order" class="px-4 py-2 bg-[#118568] text-white rounded-lg hover:bg-[#0f755a] transition-colors duration-300 text-sm">
          + Внешний заказ
        </a>
        <a href="add_general_expense" class="px-4 py-2 bg-[#5E807F] text-white rounded-lg hover:bg-[#4a6665] transition-colors duration-300 text-sm">
          + Общий расход
        </a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 mb-8">
      <div class="flex items-center justify-between mb-4">
        ...
        <a href="add_general_expense" class="px-3 py-2 bg-[#5E807F] text-white text-sm rounded-lg hover:bg-[#4a6665] transition-colors duration-300">
