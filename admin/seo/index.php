...
$pages_with_og = array_filter($seo_list, function($seo) { return !empty($seo['og_title']) || !empty($seo['og_description']) || !empty($seo['og_image']); });
?>
  ...
  <div class="container mx-auto px-4 max-w-7xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-6 text-center hover:shadow-2xl transition-shadow duration-300">
        ...
        <div class="text-3xl font-bold text-[#5E807F] mb-2"><?php echo $total_seo_settings - count($pages_with_og); ?></div>
      ...
      <div class="bg-white rounded-3xl shadow-2xl p-6 mb-12">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
          ...
          <div class="text-gray-600">
            Найдено: <?php echo count($seo_list); ?> <?php echo count($seo_list) == 1 ? 'страница' : (count($seo_list) < 5 ? 'страницы' : 'страниц'); ?>
          </div>
        </div>
              ...
              <div class="space-y-3 mb-6">
                <?php if (!empty($seo['title'])): ?>
                  <div class="text-sm">
                    ...
                    <span class="text-gray-600 ml-1"><?php echo htmlspecialchars(substr($seo['title'], 0, 50)); ?><?php echo strlen($seo['title']) > 50 ? '...' : ''; ?></span>
                  </div>
                <?php endif; ?>
                ...
                <?php if (!empty($seo['description'])): ?>
                  <div class="text-sm">
                    ...
                    <span class="text-gray-600 ml-1"><?php echo htmlspecialchars(substr($seo['description'], 0, 50)); ?><?php echo strlen($seo['description']) > 50 ? '...' : ''; ?></span>
                  </div>
                <?php endif; ?>
                ...
                <?php if (!empty($seo['keywords'])): ?>
                  <div class="text-sm">
                    ...
                    <span class="text-gray-600 ml-1"><?php echo htmlspecialchars(substr($seo['keywords'], 0, 50)); ?><?php echo strlen($seo['keywords']) > 50 ? '...' : ''; ?></span>
                  </div>
                <?php endif; ?>
              </div>
