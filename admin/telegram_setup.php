    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8">
            <div class="flex items-center mb-6">
                <div class="w-12 h-12 bg-gradient-to-r from-[#118568] to-[#17B890] rounded-xl flex items-center justify-center mr-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-start">
                            <span class="bg-[#118568] text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5">1</span>
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Если ссылка не работает, найдите @BZKPrintBot в поиске</p>
                            </div>
                        </div>
                        
                        <div class="flex items-start">
                            <span class="bg-[#118568] text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5">2</span>
                            <div>
                        ...
                        <div class="flex items-start">
                            <span class="bg-[#118568] text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5">3</span>
                            <div class="flex-1">
                                ...
                                <div class="mt-1 p-2 bg-gray-50 rounded border flex items-center justify-between">
                                    <code class="text-sm" id="connect-command">/connect <?php echo htmlspecialchars($_SESSION['user_email'] ?? 'ваш@email.com'); ?></code>
                                    <button onclick="copyToClipboard('/connect <?php echo htmlspecialchars($_SESSION['user_email'] ?? 'ваш@email.com'); ?>')" 
                        ...
                        <div class="flex items-start">
                            <span class="bg-green-500 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5">✓</span>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="flex items-center mb-6">
                <div class="w-12 h-12 bg-gradient-to-r from-[#17B890] to-[#9DC5BB] rounded-xl flex items-center justify-center mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
