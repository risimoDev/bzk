            ...
            <form method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="url" id="website" name="website" value="<?php echo e($_POST['website'] ?? ''); ?>"
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['address'] ?? ''); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="payment_terms" name="payment_terms" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['payment_terms'] ?? ''); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="delivery_terms" name="delivery_terms" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['delivery_terms'] ?? ''); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['notes'] ?? ''); ?></textarea>
                </div>
