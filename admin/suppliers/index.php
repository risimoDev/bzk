        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="/admin/suppliers/add"
                    class="px-4 py-2 bg-[#118568] text-white rounded-lg hover:bg-[#0f755a] transition-colors duration-300 font-medium flex items-center">
        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                <?php foreach ($suppliers as $supplier): ?>
                    <div
                        class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span
                                class="px-2 py-1 text-xs rounded-full <?php echo $supplier['is_active'] ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'; ?>">
                        ...
                        <div class="space-y-3 flex-grow">
                            ...
                            <?php if (!empty($supplier['website'])): ?>
                                <div class="flex items-center text-sm">
                                    ...
                                    <span
                                        class="text-[#118568] hover:underline truncate"><?php echo e($supplier['website']); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($supplier['service_cost'])): ?>
                                <div class="flex items-center text-sm">
                                    ...
                                    <span>Стоимость услуг: <?php echo number_format($supplier['service_cost'], 2, '.', ' '); ?>
                                        руб.</span>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-100 flex space-x-2">
                            <a href="/admin/suppliers/details?id=<?php echo $supplier['id']; ?>"
                                class="flex-1 text-center px-3 py-2 bg-[#118568] text-white text-sm rounded-lg hover:bg-[#0f755a] transition">
                                Подробнее
                            </a>
                            <a href="/admin/suppliers/edit?id=<?php echo $supplier['id']; ?>"
                                class="flex-1 text-center px-3 py-2 bg-gray-100 text-gray-700 text-sm rounded-lg hover:bg-gray-200 transition">
                                Редактировать
                            </a>
                        </div>
                    </div>
