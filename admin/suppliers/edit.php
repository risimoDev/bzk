            ...
            <form method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Название поставщика
                            *</label>
                    ...
                    <!-- Контактное лицо -->
                    <div>
                        <label for="contact_person" class="block text-sm font-medium text-gray-700 mb-2">Контактное
                            лицо</label>
                    ...
                    <!-- Стоимость услуг -->
                    <div>
                        <label for="service_cost" class="block text-sm font-medium text-gray-700 mb-2">Стоимость услуг
                            (руб.)</label>
                    ...
                    <div class="flex items-center pt-6">
                        <input type="checkbox" id="is_active" name="is_active" <?php echo (isset($_POST['is_active']) ? $_POST['is_active'] : $supplier['is_active']) ? 'checked' : ''; ?>
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['address'] ?? $supplier['address']); ?></textarea>
                </div>

                <!-- Условия оплаты -->
                <div>
                    <label for="payment_terms" class="block text-sm font-medium text-gray-700 mb-2">Условия
                        оплаты</label>
                    <textarea id="payment_terms" name="payment_terms" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['payment_terms'] ?? $supplier['payment_terms']); ?></textarea>
                </div>

                <!-- Условия доставки -->
                <div>
                    <label for="delivery_terms" class="block text-sm font-medium text-gray-700 mb-2">Условия
                        доставки</label>
                    <textarea id="delivery_terms" name="delivery_terms" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['delivery_terms'] ?? $supplier['delivery_terms']); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB] transition-all duration-300"><?php echo e($_POST['notes'] ?? $supplier['notes']); ?></textarea>
                </div>

                <!-- Кнопки -->
                <div class="flex justify-end space-x-4 pt-6">
                    <a href="/admin/suppliers/details?id=<?php echo $supplier['id']; ?>"
                        class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors duration-300 font-medium">
                        Отмена
                    </a>
                    <button type="submit"
                        class="px-6 py-3 bg-gradient-to-r from-[#118568] to-[#0f755a] text-white rounded-lg hover:from-[#0f755a] hover:to-[#0d654a] transition-all duration-300 font-medium">
                        Сохранить изменения
                    </button>
                </div>
            </form>
