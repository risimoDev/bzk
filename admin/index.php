...
<body class="font-sans bg-gradient-to-br from-[#DEE5E5] to-[#9DC5BB] min-h-screen">
  ...
  <main class="container mx-auto px-4 py-8 max-w-7xl">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
      ...
      <div class="w-full md:w-auto">
        <div class="flex gap-2">
          <?php echo backButton(); ?>
          <a href="/logout" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-300 text-sm">
            Выйти
          </a>
        </div>
      </div>
    ...
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-gray-700">Добро пожаловать, <?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Администратор'); ?>!</p>
  ...
  <div class="bg-white rounded-2xl shadow-xl p-6">
        ...
        <tbody>
          <?php foreach ($recent_orders as $order): ?>
            <tr class="border-b border-gray-100 hover:bg-gray-50">
              ...
              <td class="py-2 px-2 font-medium text-sm"><?php echo number_format($order['total_price'], 0, '', ' '); ?> ₽</td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
          ...
          <?php foreach ($popular_products as $product): ?>
            <div class="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-300">
              ...
              <div class="w-24 bg-gray-200 rounded-full h-2">
                <div class="bg-[#118568] h-2 rounded-full" style="width: <?php echo min(100, $product['order_count'] * 10); ?>%"></div>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
      ...
      <div class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <a href="/admin/reports" class="p-3 bg-purple-50 text-purple-700 rounded-lg text-center hover:bg-purple-100 transition-colors duration-300 text-sm">
              Отчеты
            </a>
          </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <a href="/admin/orders" class="block p-5 bg-gray-50 rounded-xl hover:bg-[#DEE5E5] transition-colors duration-300 quick-link">
        ...
        <a href="/admin/products" class="block p-5 bg-gray-50 rounded-xl hover:bg-[#DEE5E5] transition-colors duration-300 quick-link">
          <div class="flex items-center mb-3">
        ...
        <a href="/admin/users" class="block p-5 bg-gray-50 rounded-xl hover:bg-[#DEE5E5] transition-colors duration-300 quick-link">
          <div class="flex items-center mb-3">
        ...
        <a href="/admin/discounts" class="block p-5 bg-gray-50 rounded-xl hover:bg-[#DEE5E5] transition-colors duration-300 quick-link">
          <div class="flex items-center mb-3">
        ...
        <a href="/admin/partners" class="block p-5 bg-gray-50 rounded-xl hover:bg-[#DEE5E5] transition-colors duration-300 quick-link">
          <div class="flex items-center mb-3">
            <div class="w-10 h-10 bg-[#118568] rounded-lg flex items-center justify-center mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="/admin/buhgalt/index" class="block p-5 bg-gray-50 rounded-xl hover:bg-[#DEE5E5] transition-colors duration-300 quick-link">
          <div class="flex items-center mb-3">
            <div class="w-10 h-10 bg-[#17B890] rounded-lg flex items-center justify-center mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
