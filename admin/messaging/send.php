...
foreach ($recipients as $recipient) {
    ...
    $email_status = isset($recipient['email_status']) ? $recipient['email_status'] : 'pending';
    $telegram_status = isset($recipient['telegram_status']) ? $recipient['telegram_status'] : 'pending';
    ...
    <div class="container mx-auto px-6 max-w-6xl">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-700">
                <?php echo htmlspecialchars((is_array($message) && isset($message['title'])) ? $message['title'] : 'Неизвестная рассылка'); ?>
            </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-lg font-semibold">
                                <?php echo htmlspecialchars((is_array($message) && isset($message['title'])) ? $message['title'] : 'Неизвестно'); ?>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                <p class="whitespace-pre-wrap">
                                    <?php echo htmlspecialchars((is_array($message) && isset($message['content'])) ? $message['content'] : 'Нет содержания'); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <p class="font-medium">
                                    <?php
                                    $message_type = (is_array($message) && isset($message['message_type'])) ? $message['message_type'] : 'unknown';
                                    switch ($message_type) {
                                        case 'email':
                                            echo '📧 Email';
                                            break;
                            ...
                            <div>
                                ...
                                <p class="font-medium">
                                    <?php
                                    $target_audience = (is_array($message) && isset($message['target_audience'])) ? $message['target_audience'] : 'unknown';
                ...
                <!-- Список получателей -->
                <div class="bg-white rounded-3xl shadow-xl p-8">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Получатели (<?php echo count($recipients); ?>)
                    </h2>
                            ...
                            <table class="w-full">
                                ...
                                <tbody>
                                    <?php foreach ($recipients as $recipient): ?>
                                        ...
                                        $name = isset($recipient['name']) ? $recipient['name'] : 'Неизвестный';
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-medium text-green-600"><?php echo (is_array($message) && isset($message['emails_sent'])) ? $message['emails_sent'] : 0; ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Отправлено Telegram:</span>
                            <span
                                class="font-medium text-green-600"><?php echo (is_array($message) && isset($message['telegrams_sent'])) ? $message['telegrams_sent'] : 0; ?></span>
                        </div>
                    </div>
                </div>

                <!-- Управление отправкой -->
                <?php if ((is_array($message) && isset($message['status']) && $message['status'] === 'draft') && $total_pending > 0): ?>
                    <div class="bg-white rounded-3xl shadow-xl p-6">
                ...
                <?php elseif ((is_array($message) && isset($message['status']) && $message['status'] === 'sending')): ?>
                    <div class="bg-white rounded-3xl shadow-xl p-6">
