    ...
    if (!empty($title) && !empty($content)) {
        try {
            ...
            $stmt->execute([
                ...
                $specific_ids_json, $status, $scheduled_at, $_SESSION['user_id']
            ]);
      ...
      <form method="POST" class="space-y-8" id="message-form">
        ...
        <section>
          ...
          <div class="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600 mt-2">Поддерживается HTML для email рассылок и обычный текст для Telegram</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select name="message_type" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#118568] focus:ring-2 focus:ring-[#9DC5BB]">
        ...
        <section>
          ...
          <div class="space-y-4">
            ...
            <div id="schedule-fields" class="ml-7 grid grid-cols-1 md:grid-cols-2 gap-4" style="display: none;">
              <div>
        ...
        <div class="flex gap-4 pt-6">
          ...
          <a href="/admin/messaging/" class="flex-1 px-4 py-4 bg-gray-200 text-gray-700 text-center rounded-xl hover:bg-gray-300 transition font-bold text-lg">
            Отмена
          </a>
        </div>
      </form>
