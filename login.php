...
<body class="font-sans bg-gray-100">
  ...
  <main class="container mx-auto px-4 py-8">
    ...
    <form action="" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <button type="submit" name="login" class="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-300">
        Войти
      </button>
